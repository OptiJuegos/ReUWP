...
// Interfaces exposed by Windows.ApplicationModel.Core.CoreApplication.
inline constexpr GUID kCoreApplicationIid = {
    0x0AACF7A4, 0x5E1D, 0x49DF,
    {0x80, 0x34, 0xFB, 0x6A, 0x68, 0xBC, 0x5E, 0xD1}};
inline constexpr GUID kCoreApplicationExitIid = {
